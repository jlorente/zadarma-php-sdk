...
class Handler
{
    ...
    protected $exceptionsByStatusCode = [
        ...
        400 => 'BadRequest',
        // Invalid Zadarma API key provided
        401 => 'Unauthorized',
        // Parameters were valid but request failed
        402 => 'InvalidRequest',
        // The requested item doesn't exist
        404 => 'NotFound',
        // Something went wrong on Zadarma's end
        500 => 'ServerError',
        502 => 'ServerError',
        503 => 'ServerError',
        504 => 'ServerError',
     ...
     * @return void
     * @throws \Jlorente\Zadarma\Exception\ZadarmaApiException
     */
    ...
    protected function handleException($message, $statusCode, $errorType, $errorCode, $missingParameter, $rawOutput)
    {
        ...
        $class = "\\Jlorente\\Zadarma\\Exception\\{$class}Exception";
